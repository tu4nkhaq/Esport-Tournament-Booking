                        ...
                        <div class="main-content">
                            <div class="top-area justify-content-center text-center">
                                ...
                                <div class="btn-play d-flex justify-content-center align-items-center">
                                    <a href="/tournaments" class="btn text-white cmn-btn">Get Started</a>
                    ...
                    <div class="available-game-carousel">
                        @foreach ($games as $game)
                            <div class="single-item">
                                <a href="{{ $game->id }}"><img src="{{ asset($game->image) }}"
                    ...
                    <div class="single-item">
                        <div class="row">
                            <div class="col-lg-3 col-md-3 d-flex align-items-center">
                                <img class="top-img w-100" src="{{ asset($tournament->image->image) }}"
                                    alt="image">
                            </div>
